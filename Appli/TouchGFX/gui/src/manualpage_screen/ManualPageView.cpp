...
void ManualPageView::applyAbsIncVisual()
{
    if (cycleAbsMode != 0U)
    {
        // ABS mode: use action/active style generated by TouchGFX.
        AbsInc.setBitmaps(
            touchgfx::Bitmap(BITMAP_ALTERNATE_THEME_IMAGES_WIDGETS_BUTTON_REGULAR_HEIGHT_50_SMALL_ROUNDED_ACTION_ID),
            touchgfx::Bitmap(BITMAP_ALTERNATE_THEME_IMAGES_WIDGETS_BUTTON_REGULAR_HEIGHT_50_SMALL_ROUNDED_ACTIVE_ID));
    }
    else
    {
        // INC mode: use normal/pressed style generated by TouchGFX.
        AbsInc.setBitmaps(
            touchgfx::Bitmap(BITMAP_ALTERNATE_THEME_IMAGES_WIDGETS_BUTTON_REGULAR_HEIGHT_50_SMALL_ROUNDED_NORMAL_ID),
            touchgfx::Bitmap(BITMAP_ALTERNATE_THEME_IMAGES_WIDGETS_BUTTON_REGULAR_HEIGHT_50_SMALL_ROUNDED_PRESSED_ID));
    }
    AbsInc.invalidate();
}
